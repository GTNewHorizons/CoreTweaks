...
// Adapted from
// https://github.com/TheGreyGhost/MinecraftByExample/blob/1-8final/src/main/java/minecraftbyexample/usefultools/OpenGLdebugging.java
/**
 * User: The Grey Ghost
 * Date: 9/02/14
 */
public class OpenGLDebugging {
    ...
    public GLproperty[] propertyList = {
        ...
        new GLproperty(
            ...
            "transform/ enable",
            "glIsEnabled()"),
        // new GLproperty(GL11.GL_CLIP_PLANEi, "GL_CLIP_PLANEi", "User clipping plane coefficients", "transform",
        // "glGetClipPlane()"),
        // new GLproperty(GL11.GL_CLIP_PLANEi, "GL_CLIP_PLANEi", "ith user clipping plane enabled", "transform/ enable",
        // "glIsEnabled()"),
        ...
        new GLproperty(
            ...
            "polygon",
            "glGetFloatv()"),
        // new GLproperty(GL11.GL_POLYGON_OFFSET_BIAS, "GL_POLYGON_OFFSET_BIAS", "Polygon offset bias", "polygon",
        // "glGetFloatv()"),
        new GLproperty(
        ...
        new GLproperty(
            ...
            "UNUSED",
            "glGetTexLevelParameter*()"),
        // new GLproperty(GL11.GL_TEXTURE_INTERNAL, "GL_TEXTURE_INTERNAL", "x-D texture image i's internal image
        // format", "UNUSED", "glGetTexLevelParameter*()"),
        new GLproperty(
        ...
        new GLproperty(
            ...
            "texture",
            "glGetTexParameter*()"),
        // new GLproperty(GL11.GL_TEXTURE_RESIDENCY, "GL_TEXTURE_RESIDENCY", "Texture residency", "texture",
        // "glGetTexParameteriv()"),
        new GLproperty(
        ...
        // new GLproperty(GL11.GL_RED_SCALE, "GL_x_SCALE", "Value of GL_x_SCALE; x is GL_RED, GL_GREEN, GL_BLUE,
        // GL_ALPHA, or GL_DEPTH", "pixel", "glGetFloatv()"),
        // new GLproperty(GL11.GL_x_BIAS, "GL_x_BIAS", "Value of GL_x_BIAS; x is one of GL_RED, GL_GREEN, GL_BLUE,
        // GL_ALPHA, or GL_DEPTH", "pixel", "glGetFloatv()"),
        ...
        // new GLproperty(GL11.GL_x, "GL_x", "glPixelMap() translation tables; x is a map name from Table 8-1",
        // "UNUSED", "glGetPixelMap*()"),
    ...
    public static void dumpState(Consumer<String> printer) {
        for (int i = 0; i < instance.propertyList.length; ++i) {
            printer.accept(
                instance.propertyList[i].name + ":"
                    + getPropertyAsString(i)
                    + " ("
                    + instance.propertyList[i].description
                    + ")");
        }
    }

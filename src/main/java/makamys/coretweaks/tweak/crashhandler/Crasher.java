...
public class Crasher implements IModEventListener {
    ...
    private static final boolean CRASH_EVERY_CLIENT_TICK = Boolean
        .parseBoolean(System.getProperty("coretweaks.crasher.crashEveryClientTick", "false"));
    ...
    public void onClientTick(ClientTickEvent event) {
        if (Keyboard.isKeyDown(Keyboard.KEY_F3) && Keyboard.isKeyDown(Keyboard.KEY_T)
            && !KeyboardUtil.wasKeyDown(Keyboard.KEY_T)) {

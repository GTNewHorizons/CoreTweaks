...
public class GuiFatalErrorScreen extends GuiScreen {
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        ...
        this.drawString(
            ...
            this.width / 2 - 140,
            this.height / 4 - 70 + 60 + 0,
            10526880);

        this.drawString(
            this.fontRendererObj,
            "CoreTweaks caught the exception, so you should be",
            this.width / 2 - 140,
            this.height / 4 - 70 + 60 + 9 * 2,
            10526880);
        this.drawString(
            this.fontRendererObj,
            "able to continue playing.",
            this.width / 2 - 140,
            this.height / 4 - 70 + 60 + 9 * 3,
            10526880);
        ...
        if (theError != null) {
            this.drawString(
                ...
                "Caught exception:",
                this.width / 2 - 140,
                this.height / 4 - 70 + 60 + 9 * 7 + 4,
                10526880);
            this.drawString(
                this.fontRendererObj,
                theError.toString(),
                this.width / 2 - 140,
                this.height / 4 - 70 + 60 + 9 * 8 + 8,
                0xFFFF00);
            this.drawString(
                this.fontRendererObj,
                "in class",
                this.width / 2 - 140,
                this.height / 4 - 70 + 60 + 9 * 9 + 8,
                10526880);
            this.drawString(
                this.fontRendererObj,
                theError.getStackTrace()[0].getClassName(),
                this.width / 2 - 140 + 44,
                this.height / 4 - 70 + 60 + 9 * 9 + 8,
                0xFFFFFF);
        } else {
            this.drawString(
                this.fontRendererObj,
                "Caught exception on server thread.",
                this.width / 2 - 140,
                this.height / 4 - 70 + 60 + 9 * 8 + 4,
                0xFFFFFF);
        }
        this.drawString(
            this.fontRendererObj,

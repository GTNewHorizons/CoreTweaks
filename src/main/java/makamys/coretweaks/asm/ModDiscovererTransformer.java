                ...
                if (m.name.equals("findClasspathMods")) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (i.getOpcode() == INVOKEINTERFACE) {
                            ...
                            if (im.owner.equals("java/util/List") && im.name.equals("contains")
                                && im.desc.equals("(Ljava/lang/Object;)Z")) {
                                if (lastInsn.getOpcode() == INVOKEVIRTUAL) {
                                    MethodInsnNode lim = (MethodInsnNode) lastInsn;
                                    if (lim.owner.equals("java/io/File") && lim.name.equals("getName")
                                        && lim.desc.equals("()Ljava/lang/String;")) {
                                        ...
                                        callRedirectContains.add(
                                            new MethodInsnNode(
                                                INVOKESTATIC,
                                                "makamys/coretweaks/asm/ModDiscovererTransformer",
                                                "redirectKnownLibrariesContains",
                                                "(Ljava/util/List;Ljava/lang/String;Ljava/io/File;)Z",
                                                false));

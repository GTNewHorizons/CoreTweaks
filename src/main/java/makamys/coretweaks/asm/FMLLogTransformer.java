...
/**
 * <p>
 * Redirects FMLRelaunchLog#log to a safer version that shouldn't crash.
 * <p>
 * Log4j (version 2.0-beta9) is known to crash when Logger#log is called with a throwable whose stack trace contains
 ...
 * <p>
 * We use a transformer instead of a mixin because FML is a minefield for mixin errors.
 */
public class FMLLogTransformer implements IClassTransformer {
    ...
    private static byte[] transformFMLLog(byte[] bytes) {
        ...
        for (MethodNode m : classNode.methods) {
            if (m.name.equals("log") && (m.desc.equals(
                "(Ljava/lang/String;Lorg/apache/logging/log4j/Level;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V")
                || m.desc.equals(
                    "(Lorg/apache/logging/log4j/Level;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V"))) {
                ...
                for (int i = 0; i < m.instructions.size(); i++) {
                    ...
                    if (ain instanceof MethodInsnNode) {
                        ...
                        if (min.getOpcode() == INVOKESTATIC
                            && min.owner.equals("cpw/mods/fml/relauncher/FMLRelaunchLog")
                            && min.name.equals("log")
                            && min.desc.equals(m.desc)) {
                            injectionTarget = ain;
                            break;
                        }
                    }
                ...
                if (injectionTarget != null) {
                    m.instructions.insertBefore(
                        ...
                        new FieldInsnNode(
                            ...
                            "coreLog",
                            "Lcpw/mods/fml/relauncher/FMLRelaunchLog;"));
                    m.instructions.set(
                        injectionTarget,
                        new MethodInsnNode(
                            INVOKESTATIC,
                            "makamys/coretweaks/asm/FMLLogTransformer$Hooks",
                            "redirectLog",
                            m.desc.replace(")", "Lcpw/mods/fml/relauncher/FMLRelaunchLog;)"),
                            false));
                }
            }
        }
    ...
    public static class Hooks {
        ...
        public static void redirectLog(String targetLog, Level level, Throwable ex, String format, Object[] data,
            FMLRelaunchLog coreLog) {
            SafeFMLLog.log(coreLog, targetLog, level, ex, format, data);
        }

        public static void redirectLog(Level level, Throwable ex, String format, Object[] data,
            FMLRelaunchLog coreLog) {

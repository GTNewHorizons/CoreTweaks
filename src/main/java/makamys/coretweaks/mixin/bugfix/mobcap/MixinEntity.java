...
public class MixinEntity {
     ...
     *         Check what type they registered their spawn with instead, so they count towards the same mob cap type as
     *         the type of the spawn cycle during which they spawned.
     */
